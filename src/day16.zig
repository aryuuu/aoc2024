...
pub fn main() !void {
    ...
    if (should_run_part_2) {
        result = try part2(allocator, "./input/day16.txt");
    } else {
        result = try part1(allocator, "./input/day16.txt");
    }
...
test "part 1" { 
    ...
    const result = try part1(allocator, "./input/day16.test.txt");
...
//     const result = try part2(allocator, "./input/day16.test.txt");
